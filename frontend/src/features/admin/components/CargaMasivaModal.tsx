...
const CargaMasivaModal = ({ isOpen, onClose }: CargaMasivaModalProps) => {
  ...
  const descargarPlantilla = () => {
    const separador = 'sep=;\r\n'
    const cabeceras =
      'documento;tipo_documento;nombres;apellidos;correo_institucional;programa;género;semestre\r\n'
    const ejemplo =
      '1001234567;CC;Juan;Pérez;juan.perez@usco.edu.co;Ingeniería de Software;M;5\r\n'
                  ...
                  {!isLoading ? (
                    <>
                      <p className="mt-1 text-sm text-usco-gris">
                        ...
                        apellidos, correo_institucional, programa, género y semestre.
                      </p>
